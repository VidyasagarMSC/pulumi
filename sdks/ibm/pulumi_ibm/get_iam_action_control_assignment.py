...
def get_iam_action_control_assignment(assignment_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIamActionControlAssignment:getIamActionControlAssignment', __args__, opts=opts, typ=GetIamActionControlAssignmentResult, package_ref=_utilities.get_package()).value
...
def get_iam_action_control_assignment_output(assignment_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIamActionControlAssignment:getIamActionControlAssignment', __args__, opts=opts, typ=GetIamActionControlAssignmentResult, package_ref=_utilities.get_package())
