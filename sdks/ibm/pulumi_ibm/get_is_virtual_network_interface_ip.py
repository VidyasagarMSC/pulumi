...
def get_is_virtual_network_interface_ip(reserved_ip: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsVirtualNetworkInterfaceIp:getIsVirtualNetworkInterfaceIp', __args__, opts=opts, typ=GetIsVirtualNetworkInterfaceIpResult, package_ref=_utilities.get_package()).value
...
def get_is_virtual_network_interface_ip_output(reserved_ip: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsVirtualNetworkInterfaceIp:getIsVirtualNetworkInterfaceIp', __args__, opts=opts, typ=GetIsVirtualNetworkInterfaceIpResult, package_ref=_utilities.get_package())
