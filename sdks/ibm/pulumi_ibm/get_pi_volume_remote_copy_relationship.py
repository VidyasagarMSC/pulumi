...
def get_pi_volume_remote_copy_relationship(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getPiVolumeRemoteCopyRelationship:getPiVolumeRemoteCopyRelationship', __args__, opts=opts, typ=GetPiVolumeRemoteCopyRelationshipResult, package_ref=_utilities.get_package()).value
...
def get_pi_volume_remote_copy_relationship_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getPiVolumeRemoteCopyRelationship:getPiVolumeRemoteCopyRelationship', __args__, opts=opts, typ=GetPiVolumeRemoteCopyRelationshipResult, package_ref=_utilities.get_package())
