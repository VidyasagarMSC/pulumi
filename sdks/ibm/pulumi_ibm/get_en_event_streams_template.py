...
def get_en_event_streams_template(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnEventStreamsTemplate:getEnEventStreamsTemplate', __args__, opts=opts, typ=GetEnEventStreamsTemplateResult, package_ref=_utilities.get_package()).value
...
def get_en_event_streams_template_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnEventStreamsTemplate:getEnEventStreamsTemplate', __args__, opts=opts, typ=GetEnEventStreamsTemplateResult, package_ref=_utilities.get_package())
