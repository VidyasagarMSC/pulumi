...
def get_is_bare_metal_server_network_interface_reserved_ip(bare_metal_server: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsBareMetalServerNetworkInterfaceReservedIp:getIsBareMetalServerNetworkInterfaceReservedIp', __args__, opts=opts, typ=GetIsBareMetalServerNetworkInterfaceReservedIpResult, package_ref=_utilities.get_package()).value
...
def get_is_bare_metal_server_network_interface_reserved_ip_output(bare_metal_server: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsBareMetalServerNetworkInterfaceReservedIp:getIsBareMetalServerNetworkInterfaceReservedIp', __args__, opts=opts, typ=GetIsBareMetalServerNetworkInterfaceReservedIpResult, package_ref=_utilities.get_package())
