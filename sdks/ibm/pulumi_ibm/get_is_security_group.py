...
def get_is_security_group(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsSecurityGroup:getIsSecurityGroup', __args__, opts=opts, typ=GetIsSecurityGroupResult, package_ref=_utilities.get_package()).value
...
def get_is_security_group_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsSecurityGroup:getIsSecurityGroup', __args__, opts=opts, typ=GetIsSecurityGroupResult, package_ref=_utilities.get_package())
