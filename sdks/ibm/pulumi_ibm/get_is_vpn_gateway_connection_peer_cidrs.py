...
def get_is_vpn_gateway_connection_peer_cidrs(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsVpnGatewayConnectionPeerCidrs:getIsVpnGatewayConnectionPeerCidrs', __args__, opts=opts, typ=GetIsVpnGatewayConnectionPeerCidrsResult, package_ref=_utilities.get_package()).value
...
def get_is_vpn_gateway_connection_peer_cidrs_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsVpnGatewayConnectionPeerCidrs:getIsVpnGatewayConnectionPeerCidrs', __args__, opts=opts, typ=GetIsVpnGatewayConnectionPeerCidrsResult, package_ref=_utilities.get_package())
