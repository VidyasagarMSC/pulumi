...
def get_cd_toolchain_tool_jenkins(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolJenkins:getCdToolchainToolJenkins', __args__, opts=opts, typ=GetCdToolchainToolJenkinsResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_jenkins_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolJenkins:getCdToolchainToolJenkins', __args__, opts=opts, typ=GetCdToolchainToolJenkinsResult, package_ref=_utilities.get_package())
