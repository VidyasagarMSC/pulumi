...
def get_iam_trusted_profile_template(include_history: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIamTrustedProfileTemplate:getIamTrustedProfileTemplate', __args__, opts=opts, typ=GetIamTrustedProfileTemplateResult, package_ref=_utilities.get_package()).value
...
def get_iam_trusted_profile_template_output(include_history: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIamTrustedProfileTemplate:getIamTrustedProfileTemplate', __args__, opts=opts, typ=GetIamTrustedProfileTemplateResult, package_ref=_utilities.get_package())
