...
class GetSmServiceCredentialsSecretResult:
    ...
    """
    def __init__(__self__, created_at=None, created_by=None, credentials=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, labels=None, locks_total=None, name=None, next_rotation_date=None, region=None, rotations=None, secret_group_id=None, secret_group_name=None, secret_id=None, secret_type=None, source_services=None, state=None, state_description=None, ttl=None, updated_at=None, versions_total=None):
...
def get_sm_service_credentials_secret(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmServiceCredentialsSecret:getSmServiceCredentialsSecret', __args__, opts=opts, typ=GetSmServiceCredentialsSecretResult, package_ref=_utilities.get_package()).value
...
def get_sm_service_credentials_secret_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmServiceCredentialsSecret:getSmServiceCredentialsSecret', __args__, opts=opts, typ=GetSmServiceCredentialsSecretResult, package_ref=_utilities.get_package())
