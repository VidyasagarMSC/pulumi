...
def get_en_destination_sn(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationSn:getEnDestinationSn', __args__, opts=opts, typ=GetEnDestinationSnResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_sn_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationSn:getEnDestinationSn', __args__, opts=opts, typ=GetEnDestinationSnResult, package_ref=_utilities.get_package())
