...
def get_app_config_properties(collections: Optional[Sequence[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getAppConfigProperties:getAppConfigProperties', __args__, opts=opts, typ=GetAppConfigPropertiesResult, package_ref=_utilities.get_package()).value
...
def get_app_config_properties_output(collections: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getAppConfigProperties:getAppConfigProperties', __args__, opts=opts, typ=GetAppConfigPropertiesResult, package_ref=_utilities.get_package())
