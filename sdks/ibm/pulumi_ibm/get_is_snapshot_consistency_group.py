...
def get_is_snapshot_consistency_group(access_tags: Optional[Sequence[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsSnapshotConsistencyGroup:getIsSnapshotConsistencyGroup', __args__, opts=opts, typ=GetIsSnapshotConsistencyGroupResult, package_ref=_utilities.get_package()).value
...
def get_is_snapshot_consistency_group_output(access_tags: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsSnapshotConsistencyGroup:getIsSnapshotConsistencyGroup', __args__, opts=opts, typ=GetIsSnapshotConsistencyGroupResult, package_ref=_utilities.get_package())
