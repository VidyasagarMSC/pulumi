...
def get_cd_toolchain_tool_saucelabs(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolSaucelabs:getCdToolchainToolSaucelabs', __args__, opts=opts, typ=GetCdToolchainToolSaucelabsResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_saucelabs_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolSaucelabs:getCdToolchainToolSaucelabs', __args__, opts=opts, typ=GetCdToolchainToolSaucelabsResult, package_ref=_utilities.get_package())
