...
def get_cd_toolchain_tool_secretsmanager(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolSecretsmanager:getCdToolchainToolSecretsmanager', __args__, opts=opts, typ=GetCdToolchainToolSecretsmanagerResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_secretsmanager_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolSecretsmanager:getCdToolchainToolSecretsmanager', __args__, opts=opts, typ=GetCdToolchainToolSecretsmanagerResult, package_ref=_utilities.get_package())
