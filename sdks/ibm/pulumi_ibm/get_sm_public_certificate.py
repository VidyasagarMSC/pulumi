...
class GetSmPublicCertificateResult:
    ...
    """
    def __init__(__self__, alt_names=None, bundle_certs=None, ca=None, certificate=None, common_name=None, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, dns=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, intermediate=None, issuance_infos=None, issuer=None, key_algorithm=None, labels=None, locks_total=None, name=None, private_key=None, region=None, rotations=None, secret_group_id=None, secret_group_name=None, secret_id=None, secret_type=None, serial_number=None, signing_algorithm=None, state=None, state_description=None, updated_at=None, validities=None, versions_total=None):
...
def get_sm_public_certificate(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmPublicCertificate:getSmPublicCertificate', __args__, opts=opts, typ=GetSmPublicCertificateResult, package_ref=_utilities.get_package()).value
...
def get_sm_public_certificate_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmPublicCertificate:getSmPublicCertificate', __args__, opts=opts, typ=GetSmPublicCertificateResult, package_ref=_utilities.get_package())
