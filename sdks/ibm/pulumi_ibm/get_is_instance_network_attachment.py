...
def get_is_instance_network_attachment(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsInstanceNetworkAttachment:getIsInstanceNetworkAttachment', __args__, opts=opts, typ=GetIsInstanceNetworkAttachmentResult, package_ref=_utilities.get_package()).value
...
def get_is_instance_network_attachment_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsInstanceNetworkAttachment:getIsInstanceNetworkAttachment', __args__, opts=opts, typ=GetIsInstanceNetworkAttachmentResult, package_ref=_utilities.get_package())
