...
class GetCodeEngineAppResult:
    ...
    def __init__(__self__, app_id=None, build=None, build_run=None, computed_env_variables=None, created_at=None, endpoint=None, endpoint_internal=None, entity_tag=None, href=None, id=None, image_port=None, image_reference=None, image_secret=None, managed_domain_mappings=None, name=None, probe_livenesses=None, probe_readinesses=None, project_id=None, region=None, resource_type=None, run_arguments=None, run_as_user=None, run_commands=None, run_env_variables=None, run_service_account=None, run_volume_mounts=None, scale_concurrency=None, scale_concurrency_target=None, scale_cpu_limit=None, scale_down_delay=None, scale_ephemeral_storage_limit=None, scale_initial_instances=None, scale_max_instances=None, scale_memory_limit=None, scale_min_instances=None, scale_request_timeout=None, status=None, status_details=None):
        ...
        if image_port and not isinstance(image_port, float):
            raise TypeError("Expected argument 'image_port' to be a float")
        ...
        if scale_concurrency_target and not isinstance(scale_concurrency_target, float):
            raise TypeError("Expected argument 'scale_concurrency_target' to be a float")
        ...
        if scale_initial_instances and not isinstance(scale_initial_instances, float):
            raise TypeError("Expected argument 'scale_initial_instances' to be a float")
        pulumi.set(__self__, "scale_initial_instances", scale_initial_instances)
        if scale_max_instances and not isinstance(scale_max_instances, float):
            raise TypeError("Expected argument 'scale_max_instances' to be a float")
        ...
        if scale_min_instances and not isinstance(scale_min_instances, float):
            raise TypeError("Expected argument 'scale_min_instances' to be a float")
        pulumi.set(__self__, "scale_min_instances", scale_min_instances)
        if scale_request_timeout and not isinstance(scale_request_timeout, float):
            raise TypeError("Expected argument 'scale_request_timeout' to be a float")
    ...
    def image_port(self) -> _builtins.float:
    ...
    def scale_concurrency_target(self) -> _builtins.float:
    ...
    def scale_initial_instances(self) -> _builtins.float:
        return pulumi.get(self, "scale_initial_instances")

    @_builtins.property
    @pulumi.getter(name="scaleMaxInstances")
    def scale_max_instances(self) -> _builtins.float:
    ...
    def scale_min_instances(self) -> _builtins.float:
        return pulumi.get(self, "scale_min_instances")

    @_builtins.property
    @pulumi.getter(name="scaleRequestTimeout")
    def scale_request_timeout(self) -> _builtins.float:
...
def get_code_engine_app(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCodeEngineApp:getCodeEngineApp', __args__, opts=opts, typ=GetCodeEngineAppResult, package_ref=_utilities.get_package()).value
...
def get_code_engine_app_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCodeEngineApp:getCodeEngineApp', __args__, opts=opts, typ=GetCodeEngineAppResult, package_ref=_utilities.get_package())
