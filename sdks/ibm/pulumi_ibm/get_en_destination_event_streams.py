...
def get_en_destination_event_streams(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationEventStreams:getEnDestinationEventStreams', __args__, opts=opts, typ=GetEnDestinationEventStreamsResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_event_streams_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationEventStreams:getEnDestinationEventStreams', __args__, opts=opts, typ=GetEnDestinationEventStreamsResult, package_ref=_utilities.get_package())
