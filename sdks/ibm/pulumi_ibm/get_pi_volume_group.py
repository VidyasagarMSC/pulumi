...
def get_pi_volume_group(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getPiVolumeGroup:getPiVolumeGroup', __args__, opts=opts, typ=GetPiVolumeGroupResult, package_ref=_utilities.get_package()).value
...
def get_pi_volume_group_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getPiVolumeGroup:getPiVolumeGroup', __args__, opts=opts, typ=GetPiVolumeGroupResult, package_ref=_utilities.get_package())
