...
def get_cd_toolchain_tool_pipeline(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolPipeline:getCdToolchainToolPipeline', __args__, opts=opts, typ=GetCdToolchainToolPipelineResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_pipeline_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolPipeline:getCdToolchainToolPipeline', __args__, opts=opts, typ=GetCdToolchainToolPipelineResult, package_ref=_utilities.get_package())
