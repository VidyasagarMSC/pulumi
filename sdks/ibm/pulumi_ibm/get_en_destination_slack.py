...
def get_en_destination_slack(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationSlack:getEnDestinationSlack', __args__, opts=opts, typ=GetEnDestinationSlackResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_slack_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationSlack:getEnDestinationSlack', __args__, opts=opts, typ=GetEnDestinationSlackResult, package_ref=_utilities.get_package())
