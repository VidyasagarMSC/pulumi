...
def get_org(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getOrg:getOrg', __args__, opts=opts, typ=GetOrgResult, package_ref=_utilities.get_package()).value

    return AwaitableGetOrgResult(
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'),
        org=pulumi.get(__ret__, 'org'))
def get_org_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getOrg:getOrg', __args__, opts=opts, typ=GetOrgResult, package_ref=_utilities.get_package())
