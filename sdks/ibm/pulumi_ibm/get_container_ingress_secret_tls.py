...
def get_container_ingress_secret_tls(cluster: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getContainerIngressSecretTls:getContainerIngressSecretTls', __args__, opts=opts, typ=GetContainerIngressSecretTlsResult, package_ref=_utilities.get_package()).value
...
def get_container_ingress_secret_tls_output(cluster: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getContainerIngressSecretTls:getContainerIngressSecretTls', __args__, opts=opts, typ=GetContainerIngressSecretTlsResult, package_ref=_utilities.get_package())
