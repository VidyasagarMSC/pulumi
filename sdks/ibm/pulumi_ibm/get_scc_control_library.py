...
def get_scc_control_library(control_library_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSccControlLibrary:getSccControlLibrary', __args__, opts=opts, typ=GetSccControlLibraryResult, package_ref=_utilities.get_package()).value
...
def get_scc_control_library_output(control_library_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSccControlLibrary:getSccControlLibrary', __args__, opts=opts, typ=GetSccControlLibraryResult, package_ref=_utilities.get_package())
