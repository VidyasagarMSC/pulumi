...
def get_cd_toolchain_tool_artifactory(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolArtifactory:getCdToolchainToolArtifactory', __args__, opts=opts, typ=GetCdToolchainToolArtifactoryResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_artifactory_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolArtifactory:getCdToolchainToolArtifactory', __args__, opts=opts, typ=GetCdToolchainToolArtifactoryResult, package_ref=_utilities.get_package())
