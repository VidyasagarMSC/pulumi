...
class GetEnTopicResult:
    ...
    def __init__(__self__, description=None, id=None, instance_guid=None, name=None, source_count=None, sources=None, subscription_count=None, subscriptions=None, topic_id=None, updated_at=None):
        ...
        if source_count and not isinstance(source_count, float):
            raise TypeError("Expected argument 'source_count' to be a float")
    ...
    def source_count(self) -> _builtins.float:
...
def get_en_topic(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnTopic:getEnTopic', __args__, opts=opts, typ=GetEnTopicResult, package_ref=_utilities.get_package()).value
...
def get_en_topic_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnTopic:getEnTopic', __args__, opts=opts, typ=GetEnTopicResult, package_ref=_utilities.get_package())
