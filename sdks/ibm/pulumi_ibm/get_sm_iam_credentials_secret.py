...
def get_sm_iam_credentials_secret(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmIamCredentialsSecret:getSmIamCredentialsSecret', __args__, opts=opts, typ=GetSmIamCredentialsSecretResult, package_ref=_utilities.get_package()).value
...
def get_sm_iam_credentials_secret_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmIamCredentialsSecret:getSmIamCredentialsSecret', __args__, opts=opts, typ=GetSmIamCredentialsSecretResult, package_ref=_utilities.get_package())
