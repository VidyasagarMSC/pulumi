...
class GetIamTrustedProfileTemplateAssignmentResult:
    ...
    def template_version(self) -> _builtins.float:
...
def get_iam_trusted_profile_template_assignment(assignment_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIamTrustedProfileTemplateAssignment:getIamTrustedProfileTemplateAssignment', __args__, opts=opts, typ=GetIamTrustedProfileTemplateAssignmentResult, package_ref=_utilities.get_package()).value
...
def get_iam_trusted_profile_template_assignment_output(assignment_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIamTrustedProfileTemplateAssignment:getIamTrustedProfileTemplateAssignment', __args__, opts=opts, typ=GetIamTrustedProfileTemplateAssignmentResult, package_ref=_utilities.get_package())
