...
def get_en_pagerduty_template(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnPagerdutyTemplate:getEnPagerdutyTemplate', __args__, opts=opts, typ=GetEnPagerdutyTemplateResult, package_ref=_utilities.get_package()).value
...
def get_en_pagerduty_template_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnPagerdutyTemplate:getEnPagerdutyTemplate', __args__, opts=opts, typ=GetEnPagerdutyTemplateResult, package_ref=_utilities.get_package())
