...
def get_cd_toolchain_tool_cos(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolCos:getCdToolchainToolCos', __args__, opts=opts, typ=GetCdToolchainToolCosResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_cos_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolCos:getCdToolchainToolCos', __args__, opts=opts, typ=GetCdToolchainToolCosResult, package_ref=_utilities.get_package())
