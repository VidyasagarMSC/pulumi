...
def get_cd_toolchain_tool_nexus(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolNexus:getCdToolchainToolNexus', __args__, opts=opts, typ=GetCdToolchainToolNexusResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_nexus_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolNexus:getCdToolchainToolNexus', __args__, opts=opts, typ=GetCdToolchainToolNexusResult, package_ref=_utilities.get_package())
