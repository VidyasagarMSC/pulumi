...
def get_sm_imported_certificate(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmImportedCertificate:getSmImportedCertificate', __args__, opts=opts, typ=GetSmImportedCertificateResult, package_ref=_utilities.get_package()).value
...
def get_sm_imported_certificate_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmImportedCertificate:getSmImportedCertificate', __args__, opts=opts, typ=GetSmImportedCertificateResult, package_ref=_utilities.get_package())
