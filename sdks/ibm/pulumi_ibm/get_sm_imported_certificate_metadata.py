...
def get_sm_imported_certificate_metadata(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmImportedCertificateMetadata:getSmImportedCertificateMetadata', __args__, opts=opts, typ=GetSmImportedCertificateMetadataResult, package_ref=_utilities.get_package()).value
...
def get_sm_imported_certificate_metadata_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmImportedCertificateMetadata:getSmImportedCertificateMetadata', __args__, opts=opts, typ=GetSmImportedCertificateMetadataResult, package_ref=_utilities.get_package())
