...
def get_iam_api_key(apikey_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIamApiKey:getIamApiKey', __args__, opts=opts, typ=GetIamApiKeyResult, package_ref=_utilities.get_package()).value
...
def get_iam_api_key_output(apikey_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIamApiKey:getIamApiKey', __args__, opts=opts, typ=GetIamApiKeyResult, package_ref=_utilities.get_package())
