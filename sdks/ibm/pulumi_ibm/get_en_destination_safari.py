...
def get_en_destination_safari(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationSafari:getEnDestinationSafari', __args__, opts=opts, typ=GetEnDestinationSafariResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_safari_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationSafari:getEnDestinationSafari', __args__, opts=opts, typ=GetEnDestinationSafariResult, package_ref=_utilities.get_package())
