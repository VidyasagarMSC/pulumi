...
def get_en_destination_chrome(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationChrome:getEnDestinationChrome', __args__, opts=opts, typ=GetEnDestinationChromeResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_chrome_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationChrome:getEnDestinationChrome', __args__, opts=opts, typ=GetEnDestinationChromeResult, package_ref=_utilities.get_package())
