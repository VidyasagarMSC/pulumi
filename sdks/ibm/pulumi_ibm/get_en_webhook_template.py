...
def get_en_webhook_template(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnWebhookTemplate:getEnWebhookTemplate', __args__, opts=opts, typ=GetEnWebhookTemplateResult, package_ref=_utilities.get_package()).value
...
def get_en_webhook_template_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnWebhookTemplate:getEnWebhookTemplate', __args__, opts=opts, typ=GetEnWebhookTemplateResult, package_ref=_utilities.get_package())
