...
def get_en_destination_huawei(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationHuawei:getEnDestinationHuawei', __args__, opts=opts, typ=GetEnDestinationHuaweiResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_huawei_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationHuawei:getEnDestinationHuawei', __args__, opts=opts, typ=GetEnDestinationHuaweiResult, package_ref=_utilities.get_package())
