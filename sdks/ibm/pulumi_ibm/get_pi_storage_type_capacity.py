...
def get_pi_storage_type_capacity(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getPiStorageTypeCapacity:getPiStorageTypeCapacity', __args__, opts=opts, typ=GetPiStorageTypeCapacityResult, package_ref=_utilities.get_package()).value
...
def get_pi_storage_type_capacity_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getPiStorageTypeCapacity:getPiStorageTypeCapacity', __args__, opts=opts, typ=GetPiStorageTypeCapacityResult, package_ref=_utilities.get_package())
