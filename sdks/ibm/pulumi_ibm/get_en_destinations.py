...
def get_en_destinations(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinations:getEnDestinations', __args__, opts=opts, typ=GetEnDestinationsResult, package_ref=_utilities.get_package()).value
...
def get_en_destinations_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinations:getEnDestinations', __args__, opts=opts, typ=GetEnDestinationsResult, package_ref=_utilities.get_package())
