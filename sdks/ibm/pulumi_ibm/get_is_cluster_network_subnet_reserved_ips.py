...
def get_is_cluster_network_subnet_reserved_ips(cluster_network_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsClusterNetworkSubnetReservedIps:getIsClusterNetworkSubnetReservedIps', __args__, opts=opts, typ=GetIsClusterNetworkSubnetReservedIpsResult, package_ref=_utilities.get_package()).value
...
def get_is_cluster_network_subnet_reserved_ips_output(cluster_network_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsClusterNetworkSubnetReservedIps:getIsClusterNetworkSubnetReservedIps', __args__, opts=opts, typ=GetIsClusterNetworkSubnetReservedIpsResult, package_ref=_utilities.get_package())
