...
def get_sm_iam_credentials_secret_metadata(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmIamCredentialsSecretMetadata:getSmIamCredentialsSecretMetadata', __args__, opts=opts, typ=GetSmIamCredentialsSecretMetadataResult, package_ref=_utilities.get_package()).value
...
def get_sm_iam_credentials_secret_metadata_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmIamCredentialsSecretMetadata:getSmIamCredentialsSecretMetadata', __args__, opts=opts, typ=GetSmIamCredentialsSecretMetadataResult, package_ref=_utilities.get_package())
