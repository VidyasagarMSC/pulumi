...
def get_cd_toolchain_tool_jira(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolJira:getCdToolchainToolJira', __args__, opts=opts, typ=GetCdToolchainToolJiraResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_jira_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolJira:getCdToolchainToolJira', __args__, opts=opts, typ=GetCdToolchainToolJiraResult, package_ref=_utilities.get_package())
