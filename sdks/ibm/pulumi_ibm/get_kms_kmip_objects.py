...
class GetKmsKmipObjectsResult:
    ...
    def object_state_filters(self) -> Optional[Sequence[_builtins.float]]:
...
def get_kms_kmip_objects(adapter_id: Optional[_builtins.str] = None,
                         ...
                         object_state_filters: Optional[Sequence[_builtins.float]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getKmsKmipObjects:getKmsKmipObjects', __args__, opts=opts, typ=GetKmsKmipObjectsResult, package_ref=_utilities.get_package()).value
...
def get_kms_kmip_objects_output(adapter_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                ...
                                object_state_filters: Optional[pulumi.Input[Optional[Sequence[_builtins.float]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getKmsKmipObjects:getKmsKmipObjects', __args__, opts=opts, typ=GetKmsKmipObjectsResult, package_ref=_utilities.get_package())
