...
def get_dns_domain(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getDnsDomain:getDnsDomain', __args__, opts=opts, typ=GetDnsDomainResult, package_ref=_utilities.get_package()).value
...
def get_dns_domain_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getDnsDomain:getDnsDomain', __args__, opts=opts, typ=GetDnsDomainResult, package_ref=_utilities.get_package())
