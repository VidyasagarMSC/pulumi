...
def get_en_sources(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnSources:getEnSources', __args__, opts=opts, typ=GetEnSourcesResult, package_ref=_utilities.get_package()).value
...
def get_en_sources_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnSources:getEnSources', __args__, opts=opts, typ=GetEnSourcesResult, package_ref=_utilities.get_package())
