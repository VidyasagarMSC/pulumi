...
def get_en_destination_pagerduty(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationPagerduty:getEnDestinationPagerduty', __args__, opts=opts, typ=GetEnDestinationPagerdutyResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_pagerduty_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationPagerduty:getEnDestinationPagerduty', __args__, opts=opts, typ=GetEnDestinationPagerdutyResult, package_ref=_utilities.get_package())
