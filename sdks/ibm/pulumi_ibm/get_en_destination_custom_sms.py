...
def get_en_destination_custom_sms(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationCustomSms:getEnDestinationCustomSms', __args__, opts=opts, typ=GetEnDestinationCustomSmsResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_custom_sms_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationCustomSms:getEnDestinationCustomSms', __args__, opts=opts, typ=GetEnDestinationCustomSmsResult, package_ref=_utilities.get_package())
