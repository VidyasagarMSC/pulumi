...
def get_cd_toolchain_tool_privateworker(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolPrivateworker:getCdToolchainToolPrivateworker', __args__, opts=opts, typ=GetCdToolchainToolPrivateworkerResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_privateworker_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolPrivateworker:getCdToolchainToolPrivateworker', __args__, opts=opts, typ=GetCdToolchainToolPrivateworkerResult, package_ref=_utilities.get_package())
