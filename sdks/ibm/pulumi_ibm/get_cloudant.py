...
class GetCloudantResult:
    ...
    @_builtins.property
    @pulumi.getter
    def throughput(self) -> Mapping[str, _builtins.float]:
...
def get_cloudant(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCloudant:getCloudant', __args__, opts=opts, typ=GetCloudantResult, package_ref=_utilities.get_package()).value
...
def get_cloudant_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCloudant:getCloudant', __args__, opts=opts, typ=GetCloudantResult, package_ref=_utilities.get_package())
