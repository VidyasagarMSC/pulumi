...
def get_app_config_collections(expand: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getAppConfigCollections:getAppConfigCollections', __args__, opts=opts, typ=GetAppConfigCollectionsResult, package_ref=_utilities.get_package()).value
...
def get_app_config_collections_output(expand: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getAppConfigCollections:getAppConfigCollections', __args__, opts=opts, typ=GetAppConfigCollectionsResult, package_ref=_utilities.get_package())
