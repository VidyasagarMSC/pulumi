...
def get_en_slack_template(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnSlackTemplate:getEnSlackTemplate', __args__, opts=opts, typ=GetEnSlackTemplateResult, package_ref=_utilities.get_package()).value
...
def get_en_slack_template_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnSlackTemplate:getEnSlackTemplate', __args__, opts=opts, typ=GetEnSlackTemplateResult, package_ref=_utilities.get_package())
