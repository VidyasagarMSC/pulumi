...
class SccProfileArgs:
    def __init__(__self__, *,
                 ...
                 scc_profile_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        ...
        if scc_profile_id is not None:
            pulumi.set(__self__, "scc_profile_id", scc_profile_id)
    ...
    @_builtins.property
    @pulumi.getter(name="sccProfileId")
    def scc_profile_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "scc_profile_id")

    @scc_profile_id.setter
    def scc_profile_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "scc_profile_id", value)


@pulumi.input_type
class _SccProfileState:
    def __init__(__self__, *,
                 attachments_count: Optional[pulumi.Input[_builtins.float]] = None,
        ...
        :param pulumi.Input[_builtins.float] attachments_count: The number of attachments related to this profile.
        :param pulumi.Input[_builtins.float] control_parents_count: The number of parent controls for the profile.
        :param pulumi.Input[Sequence[pulumi.Input['SccProfileControlArgs']]] controls: The array of controls that are used to create the profile.
        :param pulumi.Input[_builtins.float] controls_count: The number of controls for the profile.
    ...
    def attachments_count(self) -> Optional[pulumi.Input[_builtins.float]]:
        """
    ...
    def attachments_count(self, value: Optional[pulumi.Input[_builtins.float]]):
...
@pulumi.type_token("ibm:index/sccProfile:SccProfile")
class SccProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["scc_profile_id"] = scc_profile_id
        ...
        super(SccProfile, __self__).__init__(
            'ibm:index/sccProfile:SccProfile',
            resource_name,
            __props__,
            opts,
    ...
    @_builtins.property
    @pulumi.getter(name="attachmentsCount")
    def attachments_count(self) -> pulumi.Output[_builtins.float]:
        """
        The number of attachments related to this profile.
        """
        return pulumi.get(self, "attachments_count")
    ...
    @_builtins.property
    @pulumi.getter(name="sccProfileId")
    def scc_profile_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "scc_profile_id")
