...
def get_is_cluster_network_interface(cluster_network_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsClusterNetworkInterface:getIsClusterNetworkInterface', __args__, opts=opts, typ=GetIsClusterNetworkInterfaceResult, package_ref=_utilities.get_package()).value
...
def get_is_cluster_network_interface_output(cluster_network_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsClusterNetworkInterface:getIsClusterNetworkInterface', __args__, opts=opts, typ=GetIsClusterNetworkInterfaceResult, package_ref=_utilities.get_package())
