...
def get_en_email_template(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnEmailTemplate:getEnEmailTemplate', __args__, opts=opts, typ=GetEnEmailTemplateResult, package_ref=_utilities.get_package()).value
...
def get_en_email_template_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnEmailTemplate:getEnEmailTemplate', __args__, opts=opts, typ=GetEnEmailTemplateResult, package_ref=_utilities.get_package())
