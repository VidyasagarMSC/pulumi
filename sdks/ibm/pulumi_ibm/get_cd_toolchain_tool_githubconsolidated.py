...
def get_cd_toolchain_tool_githubconsolidated(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolGithubconsolidated:getCdToolchainToolGithubconsolidated', __args__, opts=opts, typ=GetCdToolchainToolGithubconsolidatedResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_githubconsolidated_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolGithubconsolidated:getCdToolchainToolGithubconsolidated', __args__, opts=opts, typ=GetCdToolchainToolGithubconsolidatedResult, package_ref=_utilities.get_package())
