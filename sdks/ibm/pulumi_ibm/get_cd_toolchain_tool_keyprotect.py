...
def get_cd_toolchain_tool_keyprotect(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolKeyprotect:getCdToolchainToolKeyprotect', __args__, opts=opts, typ=GetCdToolchainToolKeyprotectResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_keyprotect_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolKeyprotect:getCdToolchainToolKeyprotect', __args__, opts=opts, typ=GetCdToolchainToolKeyprotectResult, package_ref=_utilities.get_package())
