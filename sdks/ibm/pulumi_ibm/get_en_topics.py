...
def get_en_topics(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnTopics:getEnTopics', __args__, opts=opts, typ=GetEnTopicsResult, package_ref=_utilities.get_package()).value
...
def get_en_topics_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnTopics:getEnTopics', __args__, opts=opts, typ=GetEnTopicsResult, package_ref=_utilities.get_package())
