...
def get_iam_trusted_profile_link(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIamTrustedProfileLink:getIamTrustedProfileLink', __args__, opts=opts, typ=GetIamTrustedProfileLinkResult, package_ref=_utilities.get_package()).value
...
def get_iam_trusted_profile_link_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIamTrustedProfileLink:getIamTrustedProfileLink', __args__, opts=opts, typ=GetIamTrustedProfileLinkResult, package_ref=_utilities.get_package())
