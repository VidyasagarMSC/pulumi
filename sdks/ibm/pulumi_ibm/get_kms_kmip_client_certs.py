...
def get_kms_kmip_client_certs(adapter_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getKmsKmipClientCerts:getKmsKmipClientCerts', __args__, opts=opts, typ=GetKmsKmipClientCertsResult, package_ref=_utilities.get_package()).value
...
def get_kms_kmip_client_certs_output(adapter_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getKmsKmipClientCerts:getKmsKmipClientCerts', __args__, opts=opts, typ=GetKmsKmipClientCertsResult, package_ref=_utilities.get_package())
