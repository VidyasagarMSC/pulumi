...
def get_container_vpc_cluster(alb_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getContainerVpcCluster:getContainerVpcCluster', __args__, opts=opts, typ=GetContainerVpcClusterResult, package_ref=_utilities.get_package()).value
...
def get_container_vpc_cluster_output(alb_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getContainerVpcCluster:getContainerVpcCluster', __args__, opts=opts, typ=GetContainerVpcClusterResult, package_ref=_utilities.get_package())
