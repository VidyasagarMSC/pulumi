...
def get_cd_toolchain_tool_hashicorpvault(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolHashicorpvault:getCdToolchainToolHashicorpvault', __args__, opts=opts, typ=GetCdToolchainToolHashicorpvaultResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_hashicorpvault_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolHashicorpvault:getCdToolchainToolHashicorpvault', __args__, opts=opts, typ=GetCdToolchainToolHashicorpvaultResult, package_ref=_utilities.get_package())
