...
class GetSmUsernamePasswordSecretResult:
    ...
    """
    def __init__(__self__, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, labels=None, locks_total=None, name=None, next_rotation_date=None, password=None, password_generation_policies=None, region=None, rotations=None, secret_group_id=None, secret_group_name=None, secret_id=None, secret_type=None, state=None, state_description=None, updated_at=None, username=None, versions_total=None):
...
def get_sm_username_password_secret(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmUsernamePasswordSecret:getSmUsernamePasswordSecret', __args__, opts=opts, typ=GetSmUsernamePasswordSecretResult, package_ref=_utilities.get_package()).value
...
def get_sm_username_password_secret_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmUsernamePasswordSecret:getSmUsernamePasswordSecret', __args__, opts=opts, typ=GetSmUsernamePasswordSecretResult, package_ref=_utilities.get_package())
