...
class SmPrivateCertificateConfigurationRootCaArgs:
    def __init__(__self__, *,
                 ...
                 sm_private_certificate_configuration_root_ca_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        if sm_private_certificate_configuration_root_ca_id is not None:
            pulumi.set(__self__, "sm_private_certificate_configuration_root_ca_id", sm_private_certificate_configuration_root_ca_id)
    ...
    @_builtins.property
    @pulumi.getter(name="smPrivateCertificateConfigurationRootCaId")
    def sm_private_certificate_configuration_root_ca_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "sm_private_certificate_configuration_root_ca_id")

    @sm_private_certificate_configuration_root_ca_id.setter
    def sm_private_certificate_configuration_root_ca_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "sm_private_certificate_configuration_root_ca_id", value)
...
class _SmPrivateCertificateConfigurationRootCaState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] crl_expiry: The time until the certificate revocation list (CRL) expires.The value can be supplied as a string representation of a
               duration in hours, such as `48h`. The default is 72 hours. In the API response, this value is returned in seconds
               (integer).**Note:** The CRL is rotated automatically before it expires.
        :param pulumi.Input[_builtins.float] crl_expiry_seconds: The time until the certificate revocation list (CRL) expires, in seconds.
        :param pulumi.Input['SmPrivateCertificateConfigurationRootCaCryptoKeyArgs'] crypto_key: The data that is associated with a cryptographic key.
        ...
        :param pulumi.Input[_builtins.str] ttl: The requested time-to-live (TTL) for certificates that are created by this CA. This field's value cannot be longer than
               the `max_ttl` limit.The value can be supplied as a string representation of a duration in hours, for example '8760h'. In
               the API response, this value is returned in seconds (integer).
        :param pulumi.Input[_builtins.float] ttl_seconds: The requested time-to-live (TTL) for certificates that are created by this CA. This field's value cannot be longer than
               the `max_ttl` limit.The value can be supplied as a string representation of a duration in hours, for example '8760h'. In
               the API response, this value is returned in seconds (integer).
...
@pulumi.type_token("ibm:index/smPrivateCertificateConfigurationRootCa:SmPrivateCertificateConfigurationRootCa")
class SmPrivateCertificateConfigurationRootCa(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["sm_private_certificate_configuration_root_ca_id"] = sm_private_certificate_configuration_root_ca_id
        ...
        super(SmPrivateCertificateConfigurationRootCa, __self__).__init__(
            'ibm:index/smPrivateCertificateConfigurationRootCa:SmPrivateCertificateConfigurationRootCa',
            resource_name,
            __props__,
            opts,
    ...
    @_builtins.property
    @pulumi.getter(name="cryptoKey")
    def crypto_key(self) -> pulumi.Output[Optional['outputs.SmPrivateCertificateConfigurationRootCaCryptoKey']]:
        """
        The data that is associated with a cryptographic key.
        """
        return pulumi.get(self, "crypto_key")
    ...
    @_builtins.property
    @pulumi.getter(name="smPrivateCertificateConfigurationRootCaId")
    def sm_private_certificate_configuration_root_ca_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "sm_private_certificate_configuration_root_ca_id")
