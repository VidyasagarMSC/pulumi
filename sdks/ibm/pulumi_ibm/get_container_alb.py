...
def get_container_alb(alb_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getContainerAlb:getContainerAlb', __args__, opts=opts, typ=GetContainerAlbResult, package_ref=_utilities.get_package()).value
...
def get_container_alb_output(alb_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getContainerAlb:getContainerAlb', __args__, opts=opts, typ=GetContainerAlbResult, package_ref=_utilities.get_package())
