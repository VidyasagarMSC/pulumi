...
def get_en_destination_ce(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationCe:getEnDestinationCe', __args__, opts=opts, typ=GetEnDestinationCeResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_ce_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationCe:getEnDestinationCe', __args__, opts=opts, typ=GetEnDestinationCeResult, package_ref=_utilities.get_package())
