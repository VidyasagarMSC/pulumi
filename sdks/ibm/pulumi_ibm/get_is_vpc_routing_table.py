...
def get_is_vpc_routing_table(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsVpcRoutingTable:getIsVpcRoutingTable', __args__, opts=opts, typ=GetIsVpcRoutingTableResult, package_ref=_utilities.get_package()).value
...
def get_is_vpc_routing_table_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsVpcRoutingTable:getIsVpcRoutingTable', __args__, opts=opts, typ=GetIsVpcRoutingTableResult, package_ref=_utilities.get_package())
