...
def get_pi_virtual_serial_numbers(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getPiVirtualSerialNumbers:getPiVirtualSerialNumbers', __args__, opts=opts, typ=GetPiVirtualSerialNumbersResult, package_ref=_utilities.get_package()).value
...
def get_pi_virtual_serial_numbers_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getPiVirtualSerialNumbers:getPiVirtualSerialNumbers', __args__, opts=opts, typ=GetPiVirtualSerialNumbersResult, package_ref=_utilities.get_package())
