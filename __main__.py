...
# Infra
vpc, subnet, ha_subnet = create_network(cfg)
...
# VPN server (standalone or HA based on config)
...
# Exports
export_outputs(cfg, vpc, subnet, secrets_manager, secrets_manager_guid, vpn_server, cert_secrets, client_configs, monitoring, tools, ha_subnet)
