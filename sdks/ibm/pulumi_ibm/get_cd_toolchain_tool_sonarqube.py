...
def get_cd_toolchain_tool_sonarqube(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolSonarqube:getCdToolchainToolSonarqube', __args__, opts=opts, typ=GetCdToolchainToolSonarqubeResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_sonarqube_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolSonarqube:getCdToolchainToolSonarqube', __args__, opts=opts, typ=GetCdToolchainToolSonarqubeResult, package_ref=_utilities.get_package())
