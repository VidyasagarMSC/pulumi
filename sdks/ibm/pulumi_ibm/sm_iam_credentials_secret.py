...
class SmIamCredentialsSecretArgs:
    def __init__(__self__, *,
                 ...
                 sm_iam_credentials_secret_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] ttl: The time-to-live (TTL) or lease duration to assign to generated credentials.For `iam_credentials` secrets, the TTL
               defines for how long each generated API key remains valid. The value is an integer that specifies the number of seconds
        ...
        :param pulumi.Input[_builtins.str] account_id: The ID of the account in which the IAM credentials are created. Use this field only if the target account is not the
        ...
        :param pulumi.Input[_builtins.str] service_id: The service ID under which the API key (see the `api_key` field) is created.If you omit this parameter, Secrets Manager
               generates a new service ID for your secret at its creation and adds it to the access groups that you assign.Optionally,
               you can use this field to provide your own service ID if you prefer to manage its access directly or retain the service
               ID after your secret expires, is rotated, or deleted. If you provide a service ID, do not include the `access_groups`
               parameter.
        ...
        if sm_iam_credentials_secret_id is not None:
            pulumi.set(__self__, "sm_iam_credentials_secret_id", sm_iam_credentials_secret_id)
    ...
    def ttl(self) -> pulumi.Input[_builtins.str]:
        """
        The time-to-live (TTL) or lease duration to assign to generated credentials.For `iam_credentials` secrets, the TTL
        defines for how long each generated API key remains valid. The value is an integer that specifies the number of seconds
        .Minimum duration is 1 minute. Maximum is 90 days.
        """
    ...
    def service_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The service ID under which the API key (see the `api_key` field) is created.If you omit this parameter, Secrets Manager
        generates a new service ID for your secret at its creation and adds it to the access groups that you assign.Optionally,
        you can use this field to provide your own service ID if you prefer to manage its access directly or retain the service
        ID after your secret expires, is rotated, or deleted. If you provide a service ID, do not include the `access_groups`
        parameter.
    ...
    @_builtins.property
    @pulumi.getter(name="smIamCredentialsSecretId")
    def sm_iam_credentials_secret_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "sm_iam_credentials_secret_id")

    @sm_iam_credentials_secret_id.setter
    def sm_iam_credentials_secret_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "sm_iam_credentials_secret_id", value)
...
class _SmIamCredentialsSecretState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] account_id: The ID of the account in which the IAM credentials are created. Use this field only if the target account is not the
               same as the account of the Secrets Manager instance. Otherwise, the field can be omitted.
        :param pulumi.Input[_builtins.str] api_key: The API key that is generated for this secret.After the secret reaches the end of its lease (see the `ttl` field), the
               API key is deleted automatically.
        ...
        :param pulumi.Input[_builtins.str] name: A human-readable name to assign to your secret.To protect your privacy, do not use personal data, such as your name or
               location, as a name for your secret.
        :param pulumi.Input[_builtins.str] next_rotation_date: The date that the secret is scheduled for automatic rotation.The service automatically creates a new version of the
               secret on its next rotation date. This field exists only for secrets that have an existing rotation policy.
        :param pulumi.Input[_builtins.str] region: The region of the Secrets Manager instance.
        :param pulumi.Input['SmIamCredentialsSecretRotationArgs'] rotation: Determines whether Secrets Manager rotates your secrets automatically.
        :param pulumi.Input[_builtins.str] secret_group_id: A UUID identifier, or `default` secret group.
        ...
        :param pulumi.Input[_builtins.str] service_id: The service ID under which the API key (see the `api_key` field) is created.If you omit this parameter, Secrets Manager
               ...
               ID after your secret expires, is rotated, or deleted. If you provide a service ID, do not include the `access_groups`
               parameter.
        :param pulumi.Input[_builtins.bool] service_id_is_static: Indicates whether an `iam_credentials` secret was created with a static service ID.If it is set to `true`, the service
               ID for the secret was provided by the user at secret creation. If it is set to `false`, the service ID was generated by
               Secrets Manager.
    ...
    def api_key(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The API key that is generated for this secret.After the secret reaches the end of its lease (see the `ttl` field), the
        API key is deleted automatically.
        """
    ...
    def next_rotation_date(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The date that the secret is scheduled for automatic rotation.The service automatically creates a new version of the
        secret on its next rotation date. This field exists only for secrets that have an existing rotation policy.
        """
    ...
    def service_id_is_static(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Indicates whether an `iam_credentials` secret was created with a static service ID.If it is set to `true`, the service
        ID for the secret was provided by the user at secret creation. If it is set to `false`, the service ID was generated by
        Secrets Manager.
        """
...
@pulumi.type_token("ibm:index/smIamCredentialsSecret:SmIamCredentialsSecret")
class SmIamCredentialsSecret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["sm_iam_credentials_secret_id"] = sm_iam_credentials_secret_id
        ...
        super(SmIamCredentialsSecret, __self__).__init__(
            'ibm:index/smIamCredentialsSecret:SmIamCredentialsSecret',
            resource_name,
            __props__,
            opts,
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            version_custom_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            versions_total: Optional[pulumi.Input[_builtins.float]] = None) -> 'SmIamCredentialsSecret':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rotation(self) -> pulumi.Output[Optional['outputs.SmIamCredentialsSecretRotation']]:
        """
        Determines whether Secrets Manager rotates your secrets automatically.
        """
        return pulumi.get(self, "rotation")
    ...
    @_builtins.property
    @pulumi.getter(name="smIamCredentialsSecretId")
    def sm_iam_credentials_secret_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "sm_iam_credentials_secret_id")
