...
def get_cd_toolchain_tool_securitycompliance(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolSecuritycompliance:getCdToolchainToolSecuritycompliance', __args__, opts=opts, typ=GetCdToolchainToolSecuritycomplianceResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_securitycompliance_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolSecuritycompliance:getCdToolchainToolSecuritycompliance', __args__, opts=opts, typ=GetCdToolchainToolSecuritycomplianceResult, package_ref=_utilities.get_package())
