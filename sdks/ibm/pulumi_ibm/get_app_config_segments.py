...
def get_app_config_segments(expand: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getAppConfigSegments:getAppConfigSegments', __args__, opts=opts, typ=GetAppConfigSegmentsResult, package_ref=_utilities.get_package()).value
...
def get_app_config_segments_output(expand: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                   ...
                                   total_count: Optional[pulumi.Input[Optional[_builtins.float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getAppConfigSegments:getAppConfigSegments', __args__, opts=opts, typ=GetAppConfigSegmentsResult, package_ref=_utilities.get_package())
