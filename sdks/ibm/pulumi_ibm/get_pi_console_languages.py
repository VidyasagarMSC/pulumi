...
def get_pi_console_languages(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getPiConsoleLanguages:getPiConsoleLanguages', __args__, opts=opts, typ=GetPiConsoleLanguagesResult, package_ref=_utilities.get_package()).value
...
def get_pi_console_languages_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getPiConsoleLanguages:getPiConsoleLanguages', __args__, opts=opts, typ=GetPiConsoleLanguagesResult, package_ref=_utilities.get_package())
