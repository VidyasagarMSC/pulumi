...
class GetIsDedicatedHostDiskResult:
    ...
    def __init__(__self__, available=None, created_at=None, dedicated_host=None, disk=None, href=None, id=None, instance_disks=None, interface_type=None, lifecycle_state=None, name=None, provisionable=None, resource_type=None, size=None, supported_instance_interface_types=None):
        if available and not isinstance(available, float):
            raise TypeError("Expected argument 'available' to be a float")
...
def get_is_dedicated_host_disk(dedicated_host: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsDedicatedHostDisk:getIsDedicatedHostDisk', __args__, opts=opts, typ=GetIsDedicatedHostDiskResult, package_ref=_utilities.get_package()).value
...
def get_is_dedicated_host_disk_output(dedicated_host: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsDedicatedHostDisk:getIsDedicatedHostDisk', __args__, opts=opts, typ=GetIsDedicatedHostDiskResult, package_ref=_utilities.get_package())
