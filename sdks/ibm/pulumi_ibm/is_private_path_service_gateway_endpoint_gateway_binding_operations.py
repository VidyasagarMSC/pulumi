...
class IsPrivatePathServiceGatewayEndpointGatewayBindingOperationsArgs:
    def __init__(__self__, *,
                 ...
                 is_private_path_service_gateway_endpoint_gateway_binding_operations_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        ...
        if is_private_path_service_gateway_endpoint_gateway_binding_operations_id is not None:
            pulumi.set(__self__, "is_private_path_service_gateway_endpoint_gateway_binding_operations_id", is_private_path_service_gateway_endpoint_gateway_binding_operations_id)
    ...
    @_builtins.property
    @pulumi.getter(name="isPrivatePathServiceGatewayEndpointGatewayBindingOperationsId")
    def is_private_path_service_gateway_endpoint_gateway_binding_operations_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "is_private_path_service_gateway_endpoint_gateway_binding_operations_id")

    @is_private_path_service_gateway_endpoint_gateway_binding_operations_id.setter
    def is_private_path_service_gateway_endpoint_gateway_binding_operations_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "is_private_path_service_gateway_endpoint_gateway_binding_operations_id", value)
...
@pulumi.type_token("ibm:index/isPrivatePathServiceGatewayEndpointGatewayBindingOperations:IsPrivatePathServiceGatewayEndpointGatewayBindingOperations")
class IsPrivatePathServiceGatewayEndpointGatewayBindingOperations(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["is_private_path_service_gateway_endpoint_gateway_binding_operations_id"] = is_private_path_service_gateway_endpoint_gateway_binding_operations_id
        ...
        super(IsPrivatePathServiceGatewayEndpointGatewayBindingOperations, __self__).__init__(
            'ibm:index/isPrivatePathServiceGatewayEndpointGatewayBindingOperations:IsPrivatePathServiceGatewayEndpointGatewayBindingOperations',
            resource_name,
            __props__,
            opts,
    ...
    @_builtins.property
    @pulumi.getter(name="isPrivatePathServiceGatewayEndpointGatewayBindingOperationsId")
    def is_private_path_service_gateway_endpoint_gateway_binding_operations_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "is_private_path_service_gateway_endpoint_gateway_binding_operations_id")
