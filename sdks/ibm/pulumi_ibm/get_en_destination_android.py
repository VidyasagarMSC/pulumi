...
def get_en_destination_android(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationAndroid:getEnDestinationAndroid', __args__, opts=opts, typ=GetEnDestinationAndroidResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_android_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationAndroid:getEnDestinationAndroid', __args__, opts=opts, typ=GetEnDestinationAndroidResult, package_ref=_utilities.get_package())
