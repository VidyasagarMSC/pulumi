...
def get_container_vpc_cluster_alb(alb_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getContainerVpcClusterAlb:getContainerVpcClusterAlb', __args__, opts=opts, typ=GetContainerVpcClusterAlbResult, package_ref=_utilities.get_package()).value
...
def get_container_vpc_cluster_alb_output(alb_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getContainerVpcClusterAlb:getContainerVpcClusterAlb', __args__, opts=opts, typ=GetContainerVpcClusterAlbResult, package_ref=_utilities.get_package())
