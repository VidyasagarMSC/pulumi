...
class SmPrivateCertificateArgs:
    def __init__(__self__, *,
                 ...
                 sm_private_certificate_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] ttl: The time-to-live (TTL) or lease duration to assign to generated credentials.For `iam_credentials` secrets, the TTL
               defines for how long each generated API key remains valid. The value can be either an integer that specifies the number
               of seconds, or the string representation of a duration, such as `120m` or `24h`.Minimum duration is 1 minute. Maximum is
               90 days.
        ...
        if sm_private_certificate_id is not None:
            pulumi.set(__self__, "sm_private_certificate_id", sm_private_certificate_id)
        if ttl is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="smPrivateCertificateId")
    def sm_private_certificate_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "sm_private_certificate_id")

    @sm_private_certificate_id.setter
    def sm_private_certificate_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "sm_private_certificate_id", value)
...
class _SmPrivateCertificateState:
    def __init__(__self__, *,
                 ...
                 revocation_time_seconds: Optional[pulumi.Input[_builtins.float]] = None,
                 rotation: Optional[pulumi.Input['SmPrivateCertificateRotationArgs']] = None,
                 secret_group_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.float] revocation_time_seconds: The timestamp of the certificate revocation.
        :param pulumi.Input['SmPrivateCertificateRotationArgs'] rotation: Determines whether Secrets Manager rotates your secrets automatically.
        :param pulumi.Input[_builtins.str] secret_group_id: A UUID identifier, or `default` secret group.
    ...
    def revocation_time_seconds(self) -> Optional[pulumi.Input[_builtins.float]]:
        """
    ...
    def revocation_time_seconds(self, value: Optional[pulumi.Input[_builtins.float]]):
...
@pulumi.type_token("ibm:index/smPrivateCertificate:SmPrivateCertificate")
class SmPrivateCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["sm_private_certificate_id"] = sm_private_certificate_id
        ...
        super(SmPrivateCertificate, __self__).__init__(
            'ibm:index/smPrivateCertificate:SmPrivateCertificate',
            resource_name,
            __props__,
            opts,
    ...
    def get(resource_name: str,
            ...
            version_custom_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            versions_total: Optional[pulumi.Input[_builtins.float]] = None) -> 'SmPrivateCertificate':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="revocationTimeSeconds")
    def revocation_time_seconds(self) -> pulumi.Output[_builtins.float]:
        """
        The timestamp of the certificate revocation.
        """
        return pulumi.get(self, "revocation_time_seconds")
    ...
    @_builtins.property
    @pulumi.getter
    def rotation(self) -> pulumi.Output[Optional['outputs.SmPrivateCertificateRotation']]:
        """
        Determines whether Secrets Manager rotates your secrets automatically.
        """
        return pulumi.get(self, "rotation")
    ...
    @_builtins.property
    @pulumi.getter(name="smPrivateCertificateId")
    def sm_private_certificate_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "sm_private_certificate_id")
