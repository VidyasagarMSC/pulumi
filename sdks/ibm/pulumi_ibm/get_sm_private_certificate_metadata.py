...
class GetSmPrivateCertificateMetadataResult:
    ...
    def __init__(__self__, alt_names=None, certificate_authority=None, certificate_template=None, common_name=None, created_at=None, created_by=None, crn=None, custom_metadata=None, description=None, downloaded=None, endpoint_type=None, expiration_date=None, id=None, instance_id=None, issuer=None, key_algorithm=None, labels=None, locks_total=None, name=None, next_rotation_date=None, region=None, revocation_time_rfc3339=None, revocation_time_seconds=None, rotations=None, secret_group_id=None, secret_id=None, secret_type=None, serial_number=None, signing_algorithm=None, state=None, state_description=None, updated_at=None, validities=None, versions_total=None):
        ...
        if revocation_time_seconds and not isinstance(revocation_time_seconds, float):
            raise TypeError("Expected argument 'revocation_time_seconds' to be a float")
    ...
    def revocation_time_seconds(self) -> _builtins.float:
...
def get_sm_private_certificate_metadata(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmPrivateCertificateMetadata:getSmPrivateCertificateMetadata', __args__, opts=opts, typ=GetSmPrivateCertificateMetadataResult, package_ref=_utilities.get_package()).value
...
def get_sm_private_certificate_metadata_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmPrivateCertificateMetadata:getSmPrivateCertificateMetadata', __args__, opts=opts, typ=GetSmPrivateCertificateMetadataResult, package_ref=_utilities.get_package())
