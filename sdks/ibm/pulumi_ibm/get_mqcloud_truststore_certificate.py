...
def get_mqcloud_truststore_certificate(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getMqcloudTruststoreCertificate:getMqcloudTruststoreCertificate', __args__, opts=opts, typ=GetMqcloudTruststoreCertificateResult, package_ref=_utilities.get_package()).value
...
def get_mqcloud_truststore_certificate_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getMqcloudTruststoreCertificate:getMqcloudTruststoreCertificate', __args__, opts=opts, typ=GetMqcloudTruststoreCertificateResult, package_ref=_utilities.get_package())
