...
def get_cd_toolchain_tool_hostedgit(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolHostedgit:getCdToolchainToolHostedgit', __args__, opts=opts, typ=GetCdToolchainToolHostedgitResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_hostedgit_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolHostedgit:getCdToolchainToolHostedgit', __args__, opts=opts, typ=GetCdToolchainToolHostedgitResult, package_ref=_utilities.get_package())
