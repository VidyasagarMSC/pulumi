...
def get_en_destination_custom_email(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationCustomEmail:getEnDestinationCustomEmail', __args__, opts=opts, typ=GetEnDestinationCustomEmailResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_custom_email_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationCustomEmail:getEnDestinationCustomEmail', __args__, opts=opts, typ=GetEnDestinationCustomEmailResult, package_ref=_utilities.get_package())
