...
def get_en_subscription_sms(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnSubscriptionSms:getEnSubscriptionSms', __args__, opts=opts, typ=GetEnSubscriptionSmsResult, package_ref=_utilities.get_package()).value
...
def get_en_subscription_sms_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnSubscriptionSms:getEnSubscriptionSms', __args__, opts=opts, typ=GetEnSubscriptionSmsResult, package_ref=_utilities.get_package())
