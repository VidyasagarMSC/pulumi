...
class SmKvSecretArgs:
    def __init__(__self__, *,
                 ...
                 sm_kv_secret_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        if sm_kv_secret_id is not None:
            pulumi.set(__self__, "sm_kv_secret_id", sm_kv_secret_id)
    ...
    @_builtins.property
    @pulumi.getter(name="smKvSecretId")
    def sm_kv_secret_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "sm_kv_secret_id")

    @sm_kv_secret_id.setter
    def sm_kv_secret_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "sm_kv_secret_id", value)
...
@pulumi.type_token("ibm:index/smKvSecret:SmKvSecret")
class SmKvSecret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["sm_kv_secret_id"] = sm_kv_secret_id
        ...
        super(SmKvSecret, __self__).__init__(
            'ibm:index/smKvSecret:SmKvSecret',
            resource_name,
            __props__,
            opts,
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            version_custom_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            versions_total: Optional[pulumi.Input[_builtins.float]] = None) -> 'SmKvSecret':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="smKvSecretId")
    def sm_kv_secret_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "sm_kv_secret_id")
