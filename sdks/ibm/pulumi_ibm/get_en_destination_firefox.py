...
def get_en_destination_firefox(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationFirefox:getEnDestinationFirefox', __args__, opts=opts, typ=GetEnDestinationFirefoxResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_firefox_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationFirefox:getEnDestinationFirefox', __args__, opts=opts, typ=GetEnDestinationFirefoxResult, package_ref=_utilities.get_package())
