...
def get_kms_key(alias: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getKmsKey:getKmsKey', __args__, opts=opts, typ=GetKmsKeyResult, package_ref=_utilities.get_package()).value
...
def get_kms_key_output(alias: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getKmsKey:getKmsKey', __args__, opts=opts, typ=GetKmsKeyResult, package_ref=_utilities.get_package())
