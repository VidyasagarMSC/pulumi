...
def get_en_destination_msteams(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationMsteams:getEnDestinationMsteams', __args__, opts=opts, typ=GetEnDestinationMsteamsResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_msteams_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationMsteams:getEnDestinationMsteams', __args__, opts=opts, typ=GetEnDestinationMsteamsResult, package_ref=_utilities.get_package())
