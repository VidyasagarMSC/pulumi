...
def get_en_destination_cos(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationCos:getEnDestinationCos', __args__, opts=opts, typ=GetEnDestinationCosResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_cos_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationCos:getEnDestinationCos', __args__, opts=opts, typ=GetEnDestinationCosResult, package_ref=_utilities.get_package())
