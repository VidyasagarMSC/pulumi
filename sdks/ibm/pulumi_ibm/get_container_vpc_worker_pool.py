...
def get_container_vpc_worker_pool(cluster: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getContainerVpcWorkerPool:getContainerVpcWorkerPool', __args__, opts=opts, typ=GetContainerVpcWorkerPoolResult, package_ref=_utilities.get_package()).value
...
def get_container_vpc_worker_pool_output(cluster: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getContainerVpcWorkerPool:getContainerVpcWorkerPool', __args__, opts=opts, typ=GetContainerVpcWorkerPoolResult, package_ref=_utilities.get_package())
