...
def get_cd_toolchain_tool_slack(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolSlack:getCdToolchainToolSlack', __args__, opts=opts, typ=GetCdToolchainToolSlackResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_slack_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolSlack:getCdToolchainToolSlack', __args__, opts=opts, typ=GetCdToolchainToolSlackResult, package_ref=_utilities.get_package())
