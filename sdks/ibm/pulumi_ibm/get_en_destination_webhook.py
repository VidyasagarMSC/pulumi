...
def get_en_destination_webhook(destination_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnDestinationWebhook:getEnDestinationWebhook', __args__, opts=opts, typ=GetEnDestinationWebhookResult, package_ref=_utilities.get_package()).value
...
def get_en_destination_webhook_output(destination_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnDestinationWebhook:getEnDestinationWebhook', __args__, opts=opts, typ=GetEnDestinationWebhookResult, package_ref=_utilities.get_package())
