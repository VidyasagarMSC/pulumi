...
def get_pag_instance(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getPagInstance:getPagInstance', __args__, opts=opts, typ=GetPagInstanceResult, package_ref=_utilities.get_package()).value
...
def get_pag_instance_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getPagInstance:getPagInstance', __args__, opts=opts, typ=GetPagInstanceResult, package_ref=_utilities.get_package())
