...
def get_is_network_acl(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getIsNetworkAcl:getIsNetworkAcl', __args__, opts=opts, typ=GetIsNetworkAclResult, package_ref=_utilities.get_package()).value
...
def get_is_network_acl_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getIsNetworkAcl:getIsNetworkAcl', __args__, opts=opts, typ=GetIsNetworkAclResult, package_ref=_utilities.get_package())
