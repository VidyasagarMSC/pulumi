...
def get_resource_instance(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getResourceInstance:getResourceInstance', __args__, opts=opts, typ=GetResourceInstanceResult, package_ref=_utilities.get_package()).value
...
def get_resource_instance_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getResourceInstance:getResourceInstance', __args__, opts=opts, typ=GetResourceInstanceResult, package_ref=_utilities.get_package())
