...
def get_cd_toolchain_tool_custom(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolCustom:getCdToolchainToolCustom', __args__, opts=opts, typ=GetCdToolchainToolCustomResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_custom_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolCustom:getCdToolchainToolCustom', __args__, opts=opts, typ=GetCdToolchainToolCustomResult, package_ref=_utilities.get_package())
