...
def get_pi_network_interfaces(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getPiNetworkInterfaces:getPiNetworkInterfaces', __args__, opts=opts, typ=GetPiNetworkInterfacesResult, package_ref=_utilities.get_package()).value
...
def get_pi_network_interfaces_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getPiNetworkInterfaces:getPiNetworkInterfaces', __args__, opts=opts, typ=GetPiNetworkInterfacesResult, package_ref=_utilities.get_package())
