...
def get_sm_private_certificate(endpoint_type: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getSmPrivateCertificate:getSmPrivateCertificate', __args__, opts=opts, typ=GetSmPrivateCertificateResult, package_ref=_utilities.get_package()).value
...
def get_sm_private_certificate_output(endpoint_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getSmPrivateCertificate:getSmPrivateCertificate', __args__, opts=opts, typ=GetSmPrivateCertificateResult, package_ref=_utilities.get_package())
