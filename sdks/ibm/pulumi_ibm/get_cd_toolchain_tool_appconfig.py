...
def get_cd_toolchain_tool_appconfig(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolAppconfig:getCdToolchainToolAppconfig', __args__, opts=opts, typ=GetCdToolchainToolAppconfigResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_appconfig_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolAppconfig:getCdToolchainToolAppconfig', __args__, opts=opts, typ=GetCdToolchainToolAppconfigResult, package_ref=_utilities.get_package())
