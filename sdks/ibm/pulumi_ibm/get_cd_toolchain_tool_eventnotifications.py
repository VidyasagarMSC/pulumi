...
def get_cd_toolchain_tool_eventnotifications(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolEventnotifications:getCdToolchainToolEventnotifications', __args__, opts=opts, typ=GetCdToolchainToolEventnotificationsResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_eventnotifications_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolEventnotifications:getCdToolchainToolEventnotifications', __args__, opts=opts, typ=GetCdToolchainToolEventnotificationsResult, package_ref=_utilities.get_package())
