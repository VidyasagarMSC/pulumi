...
def get_cd_toolchain_tool_bitbucketgit(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolBitbucketgit:getCdToolchainToolBitbucketgit', __args__, opts=opts, typ=GetCdToolchainToolBitbucketgitResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_bitbucketgit_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolBitbucketgit:getCdToolchainToolBitbucketgit', __args__, opts=opts, typ=GetCdToolchainToolBitbucketgitResult, package_ref=_utilities.get_package())
