...
def get_en_subscriptions(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getEnSubscriptions:getEnSubscriptions', __args__, opts=opts, typ=GetEnSubscriptionsResult, package_ref=_utilities.get_package()).value
...
def get_en_subscriptions_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getEnSubscriptions:getEnSubscriptions', __args__, opts=opts, typ=GetEnSubscriptionsResult, package_ref=_utilities.get_package())
