...
def get_cd_toolchain_tool_gitlab(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('ibm:index/getCdToolchainToolGitlab:getCdToolchainToolGitlab', __args__, opts=opts, typ=GetCdToolchainToolGitlabResult, package_ref=_utilities.get_package()).value
...
def get_cd_toolchain_tool_gitlab_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('ibm:index/getCdToolchainToolGitlab:getCdToolchainToolGitlab', __args__, opts=opts, typ=GetCdToolchainToolGitlabResult, package_ref=_utilities.get_package())
