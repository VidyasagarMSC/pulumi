...
class IsSshKeyArgs:
    def __init__(__self__, *,
                 ...
                 is_ssh_key_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        if is_ssh_key_id is not None:
            pulumi.set(__self__, "is_ssh_key_id", is_ssh_key_id)
        if name is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="isSshKeyId")
    def is_ssh_key_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "is_ssh_key_id")

    @is_ssh_key_id.setter
    def is_ssh_key_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "is_ssh_key_id", value)
...
class _IsSshKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] length: SSH key Length
        :param pulumi.Input[_builtins.str] name: SSH Key name
        :param pulumi.Input[_builtins.str] public_key: SSH Public key data
...
@pulumi.type_token("ibm:index/isSshKey:IsSshKey")
class IsSshKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["is_ssh_key_id"] = is_ssh_key_id
    ...
    @_builtins.property
    @pulumi.getter(name="isSshKeyId")
    def is_ssh_key_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "is_ssh_key_id")
